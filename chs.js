...
var cnItems = {
    ...
    "Amethyst Beholder Eye of Faith (Good)": "紫水晶旁观者信仰之眼（好）",
    "Amethyst Beholder Eye of Faith (Good) 1.2 armor": "紫水晶旁观者信仰之眼（好）1.2 护甲",
    ...
    " (Good)": " (好)",
    " (Good) 2.4 armor": "（好）2.4 盔甲",
    "Farwatch Hide Jerkin of the Furious Gladiator's Satin Tunic": "远望者 狂怒角斗士的皮外衣",
    "Frostwolf Boot Knife of Prismatic Focus Staff (Great)": "棱镜焦点法杖的霜狼引导刀（大）",
    " (Amazing)": "  （惊人的）",
    " (Amazing) 0.85 armor": "  （惊人）0.85护甲",
    "Hardened Leather Boots of Broken Reliance": "破碎信赖的硬化皮靴",
    "Hardened Leather Boots of Broken Reliance (Good)": "破碎信赖的硬化皮靴（好）",
    "Hateful Gladiator's Staff of Transformed Bone Cudgel of Insanity (Amazing)": "憎恨角斗士的变形狂骨棍 (Amazing)",
    "Hateful Gladiator's Staff of Transformed Bone Cudgel of Insanity (Amazing) 3.28 - 3.89 dmg": "憎恨角斗士的狂暴变形骨棍 (惊人) 3.28 - 3.89 dmg",
    ...
    "Sentinel Trousers of Conquest (Poor)": "征服哨兵长裤（劣质）",
    "Sentinel Trousers of Conquest (Poor) 0.7 armor": "征服哨兵长裤（差）0.7 护甲",
